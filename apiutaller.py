...
appname="TEAf Apiutaller" # Option: "<your program name>"
appfolder="/usr/bin/" # Option: "<your main code folder>"
appfileold="teafapiutaller.py" # Option: "<your main code file old name>"
appfilenew="teafapiutaller" # Option: "<your main code file new name>"
policyfile=any # Options: "<your policy file>" and any
appdesktopfile="teafapiutaller.desktop" # Options: "<your desktop file>" and any
mainappfolder="/usr/local/bin/" # Options: "<your way to main app folder>" and any
mainappfoldername="teafapiutaller" # Options: "<your main app folder name for icons, modules etc.>" and any
licensename="GPLv3" # # Options: "<your program's license>" and any
appdev="MuKonqi" # Option: "<your name>"
appcopyright="Copyright (C) 2022, 2023 Muhammed Abdurrahman (MuKonqi)" # Option: "<your copyright nofication>"
applicense='Licensed under the Apache License, Version 2.0 (the "License");\nyou may not use this file except in compliance with the License.\nYou may obtain a copy of the License at\n\nhttp://www.apache.org/licenses/LICENSE-2.0\n\nUnless required by applicable law or agreed to in writing, software\ndistributed under the License is distributed on an "AS IS" BASIS,\nWITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\nSee the License for the specific language governing permissions and\nlimitations under the License.' # Option: "<important section from your program's license>" 
debian_apt_support="true" # Options: For true "true", and for false "false"
debian_apt_dependencies="python3" # Options: "<your program's dependencies>" and any
fedora_dnf_support="true" # Options: For true "true", and for false "false"
fedora_dnf_dependencies="python3" # Options: "<your program's dependencies>" and any
arch_pacman_support="true" # Options: For true "true", and for false "false"
arch_pacman_dependencies="python3" # Options: "<your program's dependencies>" and any
opensuse_zypper_support="true" # Options: For true "true", and for false "false"
opensuse_zypper_dependencies="python" # Options: "<your program's dependencies>" and any
rhel_yum_support="true" # Options: For true "true", and for false "false"
rhel_yum_dependencies="python3" # Options: "<your program's dependencies>" and any
solus_eopkg_support="true" # Options: For true "true", and for false "false"
solus_eopkg_dependencies="python3" # Options: "<your program's dependencies>" and any
void_xbps_support="true" # Options: For true "true", and for false "false"
void_xbps_dependencies="python3" # Options: "<your program's dependencies>" and any
pisi_pisi_support="true" # Options: For true "true", and for false "false"
pisi_pisi_dependencies="python3" # Options: "<your program's dependencies>" and any
other_gnulinux_support="true" # Options: For true "true", and for false "false"
